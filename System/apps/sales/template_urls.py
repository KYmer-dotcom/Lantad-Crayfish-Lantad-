...
urlpatterns = [
    ...
    path('rider/location/update/', template_views.rider_location_update, name='rider_location_update'),
    path('rider/delivery/<int:delivery_id>/action/', template_views.rider_delivery_action, name='rider_delivery_action'),
    path('delivery/<int:delivery_id>/live-location/', template_views.delivery_live_status, name='delivery_live_status'),
